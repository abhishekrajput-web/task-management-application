...
// const extractRapidApiText = (data) => {
//   // Try common shapes safely. Adjust if your API returns a different structure.
//   if (typeof data === 'string') return data;
//   if (typeof data?.text === 'string') return data.text;

//   // OpenAI-like
//   const openAiLike = data?.choices?.[0]?.message?.content;
//   if (typeof openAiLike === 'string') return openAiLike;

//   if (typeof data?.result === 'string') return data.result;
//   if (typeof data?.output === 'string') return data.output;

//   if (data?.data) return extractRapidApiText(data.data);
//   return null;
// };
...
// const callGrokRapidApi = async (prompt) => {
//   const rapidKey = process.env.RAPIDAPI_KEY;
//   const rapidHost = process.env.RAPIDAPI_HOST;
//   const rapidUrl =
//     process.env.RAPIDAPI_GROK_URL || 'https://grok-3-0-ai.p.rapidapi.com/';

//   if (!rapidKey || !rapidHost) return null;
...
//   if (!resp.ok) {
//     console.error('RapidAPI Grok Error:', resp.status, data);
//     return null;
//   }

//   const text = extractRapidApiText(data);
...
//     const text = await callGrokRapidApi(prompt);
//     if (!text) return getMockSuggestion(tasks);

//     return {
//       success: true,
//       suggestion: text,
//       source: 'grok-rapidapi',
//       taskCount: tasks.length,
//     };
//   } catch (error) {
//     console.error('RapidAPI Grok Error:', error);
//     return getMockSuggestion(tasks);
//   }
// };

// /**
//  * AI Task Suggestion (Improve task)
//  * Returns structured JSON in `data` if possible.
//  */
...
//     // If parsed JSON matches expected, return data; else keep raw text as suggestion
//     if (parsed && parsed.improvedTitle) {
//       return { success: true, data: parsed, source: 'grok-rapidapi' };
//     }
...
// /**
//  * AI Task Breakdown (Break a large task into subtasks)
//  */
...
// /**
//  * Intelligent mock suggestion based on task analysis
//  * (KEEPED from your original file unchanged)
//  */
...
//   // Determine what to work on first
